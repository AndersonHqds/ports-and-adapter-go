...
import (
	...
	dbInfra "github.com/andersonhqds/ports-and-adapter-go/adapters/db"
...
func init() {
	...
	// rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.ports-and-adapter-go.yaml)")
